...
const en = {
  ...
  guideIntro: 'Follow the stages in order — each stage unlocks the next. A plain-text alternative to the roadmap graph.',
  stage: 'Stage',
  requires: 'Requires',
...
const id: Record<UIStringKey, string> = {
  ...
  guide: 'Panduan',
  stepGuide: 'Panduan langkah demi langkah',
  guideIntro: 'Ikuti tahapannya secara berurutan — setiap tahap membuka tahap berikutnya. Alternatif teks biasa dari graf peta jalan.',
  stage: 'Tahap',
